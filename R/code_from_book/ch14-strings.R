...
# here is a challengin string

x1 <- "text\nEl Ni\xf1o was particularly bad this year"

read_csv(x1)$text # this fails

x2 <- "text\n\x82\xb1\x82\xf1\x82\xc9\x82\xbf\x82\xcd"

read_csv(x2)$text # this also fails

# The next two work....

read_csv(x1, locale = locale(encoding = "Latin1"))$text # Neither of these works
...
# Turkish has two i’s: with and without a dot. Since they’re two distinct 
#  letters, they’re capitalized differently:
...
# in Czech, “ch” is a compound letter that appears after h in the alphabet.
